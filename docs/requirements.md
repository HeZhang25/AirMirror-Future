...
| AMF-RIS-011 | 在 Foundation final exit/P1A 前固定 aperture/control/pattern、仅细化独立 quadrature，冻结可重放的 coefficient policy 和声明适用域 | Ready | [ADR-0008](adr/0008-minimum-aperture-quadrature-validity-gate.md)、[FND-QA-AP](work_items/foundation_0_1_1_qa_ap.md) | FND-QA-AP-01 preregistration signed/frozen；independent final Ready Review PASS，blocking issues 0；后续 FND-T16..18、versioned QA matrix；不等同 EM/full-wave truth |

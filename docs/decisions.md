...
| 基线版本 | v0.1 + Foundation ADR-0006..0011 |
...
| [0009](adr/0009-environment-modifier-propagation-profile.md) | Foundation Profile 是 environment-only complex modifier；Scene v1 不持有 Python Profile | Accepted | simulation、physics、scenarios、provenance、future cache |
